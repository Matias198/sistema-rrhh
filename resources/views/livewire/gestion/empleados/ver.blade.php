<div>
            ...
            <div class="row mb-3">
                ...
                @if ($persona->departamento != null)
                    <div class="col">
                        ...
                        <input readonly type="text" name="departamento" id="departamento" class="form-control"
                            value="{{ $persona->departamento }}" autocomplete="off">
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="card card-primary collapsed-card">
        ...
        <!-- /.card-header -->
        <div class="card-body" style="display: none;">
            @if (!empty($persona->familiares()->get()))
                <div class="row mb-3">
    ...
    <div class="card card-primary collapsed-card">
        ...
        <!-- /.card-header -->
        <div class="card-body" style="display: none;">
            @if (!empty($persona->obrasSociales()->get()))
                <div class="row mb-3">
                    <div class="col-9">
        ...
        <div class="card-body" style="display: none;">
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input readonly type="text" name="puesto_de_trabajo_selected" id="puesto_de_trabajo_selected"
                        class="form-control" value="{{ $persona->empleado->puesto->titulo_puesto }}"
                        autocomplete="off">
                </div>
                <div class="col">
    ...
    <div class="card card-primary collapsed-card">
        ...
        <div class="card-body" style="display: none;">
            ...
            @if (!empty($persona->empleado->competencias()->get()))
                ...
                @foreach ($persona->empleado->competencias()->get() as $competencia)
                    <div class="row mb-3">
                        <div class="col">
                            <div class="icheck-primary icheck-inline">
                                <input disabled type="checkbox" id="cchb{{ $competencia->id }}"
                                    name="cchb{{ $competencia->id }}" value="{{ $competencia->id }}"
                                    @if (in_array($competencia->nombre, $capacidades)) checked @endif>
                    ...
                    <tbody>
                        @foreach ($persona->documentosCertificados()->get() as $documento)
                            <tr>
                                ...
                                @hasanyrole('DIRECTOR|JEFE|SYSADMIN')
                                    @if ($documento->estado == 1)
                                        <td>
    ...
    <input type="file" name="documento_file" hidden accept=".pdf,.doc,.docx,.png,.jpg,.jpeg" id="documento_file"
        class="form-control" wire:model="documento_file" placeholder="Ingrese el documento" autocomplete="off"
        x-on:change="mostrarNombreFile()">
</div>
<script>
